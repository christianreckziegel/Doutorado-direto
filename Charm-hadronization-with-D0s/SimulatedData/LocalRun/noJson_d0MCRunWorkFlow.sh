...
o2-analysis-je-jet-finder-d0-mcp-charged {OPTION} | \
o2-analysis-je-jet-finder-d0-mcd-charged {OPTION} | \
o2-analysis-je-jet-matching-mc {OPTION} | \
o2-analysis-je-jet-hf-fragmentation -b --aod-writer-keep AOD/MCPJETDISTTABLE/0 --aod-file AO2D_LHC22o_pass4_minBias_small.root --aod-memory-rate-limit 2000000000 --shm-segment-size 16000000000 --min-failure-level error
