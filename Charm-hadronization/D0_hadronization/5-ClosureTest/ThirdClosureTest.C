...
ClosureTestData3 createAnalysisObjects(TFile* fClosureInput, double& jetptMin, double& jetptMax, double& hfptMin, double& hfptMax, 
    ...
    ClosureTestData3 dataContainer;
...
void unfoldInputDetector(ClosureTestData3& dataContainer, int& iterationNumber) {
...
void plotHistograms(const ClosureTestData3& dataContainer, const double& jetptMin, const double& jetptMax) {
...
void saveData(const ClosureTestData3& dataContainer, const double& jetptMin, const double& jetptMax){
    // Open output file
...
void ThirdClosureTest(){
    ...
    // ----3: Subtract non-prompt candidates contribution
    TH2D* hFeddown = FeedDownClosure(fClosureInputNonMatched, fClosureInputMatched, fPowheg, hEfficiencyCorrected, binningStruct, bdtPtCuts);
