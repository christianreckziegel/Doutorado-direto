...
OUTPUT_DIR="AnalysisResults_non_merged"
...
echo "===== AnalysisResults DOWNLOAD START =====" | tee -a "$LOGFILE"
date | tee -a "$LOGFILE"
...
download_one() {
    ...
    outfile="${OUTPUT_DIR}/AnalysisResults_\${jobid}.root"
    ...
    for ((i=1; i<=${N_RETRIES}; i++)); do
        ...
        alien_cp alien:\${path}/001/AnalysisResults.root file:\${outfile}
